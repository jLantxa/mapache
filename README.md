...
|---------|---------|--------------|--------------|--------------|---------------|-------------|-----------|
| mapache | backup  |         1.99 |         2.05 |       287.83 |        291.26 |     1356.91 |    303.62 |
| restic  | backup  |         4.01 |         4.11 |       806.78 |        821.06 |     1266.24 |    308.89 |
| mapache | restore |        13.60 |        13.70 |       414.89 |        434.01 |      264.13 |      0.00 |
| restic  | restore |        17.56 |        17.60 |       244.09 |        256.56 |      142.81 |      0.00 |

### enron

| Tool    | Action  | Avg Time (s) | Max Time (s) | Avg PSS (MB) | Peak PSS (MB) | Avg CPU (%) | Repo (MB) |
|---------|---------|--------------|--------------|--------------|---------------|-------------|-----------|
| mapache | backup  |         5.96 |         6.28 |       418.30 |        433.22 |     1097.88 |    714.52 |
| restic  | backup  |        10.99 |        11.06 |       861.37 |        868.91 |     1177.37 |    725.14 |
| mapache | restore |        72.43 |        73.15 |       620.96 |        642.41 |      218.40 |      0.00 |
| restic  | restore |        79.81 |        80.39 |       445.44 |        449.04 |      146.78 |      0.00 |
