...
pub async fn run(global_args: &GlobalArgs, args: &CmdArgs) -> Result<()> {
    ...
    with_repository_lock(
        ...
        |repo, _, lock_handle| async move {
            ...
            eprintln!("DEBUG: exclude from args: {:?}", args.exclude);
            eprintln!("DEBUG: all_excludes: {:?}", all_excludes);
            ...
            new_snapshot.summary.processed_items_count =
                snapshot_report_summary.processed_items_count;
                ...
                if global_args.json {
                    ...
                    ui::json_reporter::emit_static(
                        ...
                        &SnapshotCompleteMsg {
                            ...
                            compressed_bytes_meta: repo_stats.meta.encoded
                                + new_snapshot_size.encoded,
