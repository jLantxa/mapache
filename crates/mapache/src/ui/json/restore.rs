...
impl JsonRestoreState {
    ...
    fn emit_status_update(&self) {
        ...
        let skipped_bytes = self.skipped_bytes_count.load(Ordering::Relaxed);
...
mod tests {
    ...
    fn returned_counters_reflect_emitted_events() {
        ...
        emit(RestoreEvent::BlobsSkipped {
            count: 5,
            bytes: 22,
        });
        ...
        assert_eq!(skipped.load(Ordering::Relaxed), 22, "skipped bytes");
    }
}
