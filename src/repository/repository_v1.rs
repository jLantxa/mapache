...
impl RepositoryBackend for Repository {
    ...
    fn open(
        ...
        let shuffle_blobs = true;
        let add_blob_padding = true;

        let data_packer = Arc::new(RwLock::new(Packer::new(shuffle_blobs, add_blob_padding)));
        let tree_packer = Arc::new(RwLock::new(Packer::new(shuffle_blobs, add_blob_padding)));
