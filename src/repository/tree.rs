...
impl Node {
    ...
    pub fn from_path(path: PathBuf) -> Result<Self> {
        ...
        let mut node = Self {
            ...
            contents: None,
            tree: None,
            symlink_target: None, // Initialize to None
                                  // Add rdev here if you also updated Metadata to include it for special files
                                  // rdev: None,
        };
        ...
        // If you are storing rdev in Metadata and you have BlockDevice/CharDevice types,
        // you would populate it here:
        // #[cfg(unix)]
        // if node.node_type == NodeType::BlockDevice || node.node_type == NodeType::CharDevice {
        //     node.metadata.rdev = Some(meta.rdev());
        // }
